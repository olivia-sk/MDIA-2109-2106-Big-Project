...
export default function ResultsThree() {
  return (
    <>
      <Head>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content_container}>
            <h3 className={styles.subtitle}>
              The Addiction can be scaled as severe.
            </h3>
            <p className={styles.description}>
              The substance misuse is effecting the everyday life of the user,
              or those around them.
            </p>
            <h3 className={styles.subtitle}>
              Recovery is a difficult process at this stage
            </h3>
          </div>
