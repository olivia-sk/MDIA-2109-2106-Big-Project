...
export default function ResultsTwo() {
  return (
    <>
      <Head>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content_container}>
            <h3 className={styles.subtitle}>
              The Addiction can be scaled as moderate.
            </h3>
            <p className={styles.description}>
              The substance misuse is starting to effect the everyday life of
              the user, or those around them.
            </p>
            <h3 className={styles.subtitle}>
              Recovery is a manageable process at this stage
            </h3>
          </div>
